#define NGX_CONFIGURE " --conf-path=/usr/local/Host-Manager/confs/nginx.conf --without-http_rewrite_module"
...
#define NGX_CONF_PREFIX  "/usr/local/Host-Manager/confs/"
#endif
...
#define NGX_CONF_PATH  "/usr/local/Host-Manager/confs/nginx.conf"
#endif
